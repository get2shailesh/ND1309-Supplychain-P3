...
const truffleAssert = require('truffle-assertions'); //SD: Added for assertion testing since original code was giving error.
...
contract('SupplyChain', function(accounts) {
    ...
    const productPrice = web3.utils.toWei("1", "ether") // SD: converted toWei to util.toWei due to error
    var itemState = 0
