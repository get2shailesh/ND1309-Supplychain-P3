...
contract SupplyChain is Ownable, FarmerRole, DistributorRole, RetailerRole, ConsumerRole {
  ...
  // Define 'owner'
  // address owner; -- SD: Commented this since its already deifned in ownable.sol
  ...
  /* -- SD: Commented onlyOwner Ownable already has this modifiers and many functions
  modifier onlyOwner() {
...
*/
  ...
  // SD: Define a modifier that checks if an item does not exist, this will help to create item only when doesn't exist
  ...
  constructor() public payable {
    //owner = msg.sender; - commenting this since owner is not defined here.
    sku = 1;
    upc = 1;
  }
...
*/
  ...
  function buyItem(uint _upc) public payable onlyDistributor forSale(_upc) paidEnough(msg.value) checkValue(_upc) 
    {
